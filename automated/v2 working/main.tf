...
module "vectortask_ec2" {
  ...
  public_subnet_id = module.vectortask_vpc.public_subnet_ids[0]
  private_subnet_id = module.vectortask_vpc.private_subnet_ids[0]
...
output "jump_server_id" {
  value = module.vectortask_ec2.jump_server_id
}

output "jump_server_public_ip" {
  value = module.vectortask_ec2.jump_server_public_ip
}
